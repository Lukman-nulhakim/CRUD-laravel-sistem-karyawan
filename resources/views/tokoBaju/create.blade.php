    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-md-12">
                ...
                <hr>
                <form action="{{ route('tokoBaju.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="alamat_toko" name="alamat_toko" rows="3">{{ old('alamat_toko') }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="merk_baju">Merk Baju</label>
                        <input type="text" class="form-control @error('merk_baju') is-invalid @enderror" id="merk_baju" name="merk_baju" value="{{ old('merk_baju') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2 mr-sm-2">
                            ...
                            <input type="text" class="form-control @error('harga') is-invalid @enderror" placeholder="Harga" id="harga" name="harga" value="{{ old('harga') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="warna" id="warna" class="form-control" >
                            ...
                            <option value="Kuning" {{ old('warna') == 'Kuning' ? 'selected' : '' }}>
                                Kuning
                            </option>
